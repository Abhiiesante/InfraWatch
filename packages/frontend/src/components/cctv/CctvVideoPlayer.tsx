...
export function CctvVideoPlayer({
  ...
  return (
    <div className={className} style={{ height }}>
      ...
      {/* Remote PC Camera Modal Box */}
      {showRemoteModal && (
        <div className="absolute inset-0 bg-slate-950/95 backdrop-blur-md z-30 p-6 flex flex-col justify-center animate-in fade-in">
            ...
            <div className="space-y-4 font-mono text-xs text-slate-300">
              <div className="p-3 rounded-xl bg-slate-900 border border-slate-800 text-[11px] text-slate-300 space-y-1">
                ...
                <div className="flex items-center gap-2">
                  <p className="flex-1 font-extrabold text-cyan-300 bg-slate-950 px-3 py-2 rounded-xl border border-cyan-700/80 select-all text-xs font-mono tracking-wide">
                    {lanBroadcastUrl}
                  </p>
                  <button
                    onClick={() => {
                    ...
                    className="px-3 py-2 bg-cyan-950 hover:bg-cyan-900 border border-cyan-700 text-cyan-300 rounded-xl text-[10px] font-bold transition-all"
                  >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-900 border border-cyan-700/60 rounded-xl px-4 py-2.5 text-center text-2xl font-black tracking-widest text-cyan-300 focus:border-cyan-400 outline-none shadow-inner"
                />
              </div>
            ...
            <div className="space-y-3 font-mono text-xs text-slate-300">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-900 border border-slate-700 rounded-xl px-3 py-2 text-white focus:border-cyan-500 outline-none"
                />
              </div>
